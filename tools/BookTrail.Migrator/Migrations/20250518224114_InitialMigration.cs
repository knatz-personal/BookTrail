        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    BookId = table.Column<long>(type: "bigint", nullable: false),
                    RecommendedByUserId = table.Column<Guid>(type: "uuid", nullable: true),
                    RecommendedById = table.Column<Guid>(type: "uuid", nullable: true),
                    Reason = table.Column<string>(type: "text", nullable: true),
                    DateRecommended = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookShelfItem", x => new { x.ShelfId, x.BookId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReadLog", x => new { x.UserId, x.BookId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Recommendation_RecommendedById",
                table: "Recommendation",
